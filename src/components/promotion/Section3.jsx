      ...
      <Container maxWidth="lg">
        ...
        >
          {[
            ...
            >
              <Icon icon="mdi:check-circle" width={22} color="#AD1490" />
        ...
        <Box
          sx={{
            ...
            pt: "2px",
            background:
              "linear-gradient( 90deg, #AD1490 0%, #C20F88 25%, #F9465F 50%, #FF8647 75%, #FFCF4E 100%)",
          }}
        >
          <Typography
            sx={{
          ...
          <video
            src="https://d1tf9w75wfom5c.cloudfront.net/wallpilates/VID_032124_KasAD_Taylor_Carbs%20(1).mp4"
            controls
            preload="auto"
            style={{
              width: "100%",
